...
"use strict";(()=>{var r={bgPrimary:"rgba(10, 14, 22, 0.92)",bgSecondary:"rgba(18, 26, 40, 0.75)",bgHover:"rgba(35, 48, 70, 0.6)",textPrimary:"#e7f1ff",textSecondary:"rgba(231, 241, 255, 0.7)",textMuted:"rgba(231, 241, 255, 0.5)",accent:"rgba(46, 211, 241, 0.95)",accentHover:"rgba(99, 224, 255, 0.95)",accentMuted:"rgba(46, 211, 241, 0.18)",accentAlt:"rgba(99, 110, 255, 0.9)",success:"rgba(20, 220, 170, 0.9)",successSolid:"#38d9a9",warning:"#f2c94c",error:"#ff7d87",highlight:"rgba(88, 211, 255, 0.2)",border:"rgba(120, 140, 180, 0.3)",borderAccent:"rgba(46, 211, 241, 0.55)"},u={display:"'Trebuchet MS', 'Segoe UI', Tahoma, Verdana, sans-serif",body:"'Segoe UI', Tahoma, Verdana, sans-serif",mono:"'Consolas', 'Courier New', monospace"},n={xs:"4px",sm:"8px",md:"12px",lg:"16px",xl:"20px",xxl:"24px"},p={sm:"4px",md:"6px",lg:"8px",xl:"12px"},T={sm:"0 2px 8px rgba(3, 8, 18, 0.35)",md:"0 10px 22px rgba(3, 8, 18, 0.45)",lg:"0 24px 40px rgba(2, 6, 16, 0.55), 0 0 24px rgba(46, 211, 241, 0.08)"},l={fast:"0.12s",normal:"0.2s",slow:"0.3s"};var _={threadCount:20,lobbyPollingRate:1e3},M={lobbyDiscoverySettings:"OF_LOBBY_DISCOVERY_SETTINGS",lobbyDiscoveryPanelSize:"OF_LOBBY_DISCOVERY_PANEL_SIZE",playerListPanelPosition:"OF_PLAYER_LIST_PANEL_POSITION",playerListPanelSize:"OF_PLAYER_LIST_PANEL_SIZE",playerListShowOnlyClans:"OF_PLAYER_LIST_SHOW_ONLY_CLANS",playerListCollapseStates:"OF_PLAYER_LIST_COLLAPSE_STATES",playerListRecentTags:"OF_PLAYER_LIST_RECENT_TAGS"},$={panel:9998,panelOverlay:9999,modal:1e4,notification:2e4};function O(){return`
    ...
    .of-panel {
      ...
      animation: ofPanelEnter ${l.slow} ease;
    }
    ...
    .of-button {
      ...
      font-size: 0.95em;
      font-weight: 600;
      transition: background ${l.fast}, border-color ${l.fast}, color ${l.fast};
      outline: none;
    }
    ...
    .of-toggle {
      ...
      border: 1px solid ${r.border};
      position: relative;
      transition: background ${l.fast}, border-color ${l.fast};
      cursor: pointer;
    }
    .of-toggle.on { background: ${r.successSolid}; }
    .of-toggle-ball {
      position: absolute; left: 2px; top: 2px; width: 14px; height: 14px;
      border-radius: 50%; background: #fff; transition: left ${l.fast};
    }
    ...
    .of-resize-handle {
      ...
      z-index: ${$.panel+1};
      opacity: 0.35;
      transition: opacity ${l.fast}, box-shadow ${l.fast};
    }
    ...
    .of-player-list-count { font-size: 0.72em; letter-spacing: 0.12em; font-family: ${u.mono}; }
    .of-player-debug-info { font-size: 0.75em; color: rgba(148, 170, 210, 0.7); padding: 2px 6px; display: none; font-family: ${u.mono}; }
    ...
    .of-quick-tag-remove {
      ...
      transition: background ${l.fast}, border-color ${l.fast}, transform ${l.fast};
    }
    ...
    .of-clan-group-enter {
      animation: clanGroupEnter ${l.slow} cubic-bezier(.27,.82,.48,1.06) forwards;
    }
    ...
    .of-clan-group-players {
      ...
      overflow: visible;
      transition: max-height ${l.normal} ease-in-out, opacity ${l.normal} ease-in-out;
    ...
    .of-player-list-content > .of-player-item {
      ...
      line-height: 1.4;
      position: relative;
      transition: background-color ${l.slow}, border-color ${l.slow};
      cursor: default;
      display: flex;
      align-items: center;
      justify-content: space-between;
    ...
    .of-player-enter { animation: playerEnter ${l.slow} cubic-bezier(.27,.82,.48,1.06) forwards; }
    ...
    .of-player-list-button { background: ${r.bgHover}; border: 1px solid ${r.border}; color: ${r.textPrimary}; padding: 6px 13px; border-radius: ${p.md}; cursor: pointer; font-size: 0.9em; font-weight: 600; transition: background ${l.fast}, border-color ${l.fast}; outline: none; }
    ...
    .discovery-panel {
      ...
      border-radius: ${p.lg};
      box-shadow: ${T.lg};
      transition: opacity ${l.slow}, transform ${l.slow};
      cursor: default;
      overflow: hidden;
    }
    ...
    .select-all-btn { background: rgba(46, 211, 241, 0.15); color: ${r.textPrimary}; border: 1px solid ${r.borderAccent}; border-radius: ${p.sm}; padding: ${n.xs} ${n.sm}; font-size: 0.75em; cursor: pointer; flex: 1; text-align: center; margin: 0 2px; text-transform: uppercase; letter-spacing: 0.1em; font-family: ${u.display}; }
    ...
    .team-count-section > label { font-size: 0.8em; color: ${r.textPrimary}; font-weight: 600; margin-bottom: 4px; display: block; text-transform: uppercase; letter-spacing: 0.08em; font-family: ${u.display}; }
    ...
    .discovery-binary-label {
      ...
      text-transform: uppercase;
      font-family: ${u.display};
      transition: background ${l.fast}, color ${l.fast}, box-shadow ${l.fast};
      user-select: none;
      white-space: nowrap;
    }
    ...
    .capacity-slider::-webkit-slider-thumb { -webkit-appearance: none; width: 16px; height: 16px; border-radius: 50%; background: ${r.accent}; cursor: pointer; pointer-events: all; border: 2px solid rgba(5, 20, 26, 0.9); box-shadow: ${T.sm}; }
    ...
    .capacity-label-group label { font-size: 0.8em; color: ${r.textSecondary}; font-weight: 600; margin: 0; text-transform: uppercase; letter-spacing: 0.08em; font-family: ${u.display}; }
    ...
    .status-text { font-size: 0.8em; color: ${r.textPrimary}; text-transform: uppercase; letter-spacing: 0.12em; font-family: ${u.display}; }
    .search-timer { font-size: 0.8em; color: rgba(147, 197, 253, 0.9); font-weight: 500; font-family: ${u.mono}; }
    .discovery-settings { display: flex; align-items: center; gap: ${n.sm}; flex-wrap: wrap; }
    .discovery-toggle-label { display: flex; align-items: center; gap: 6px; cursor: pointer; font-size: 0.8em; color: ${r.textPrimary}; font-family: ${u.display}; text-transform: uppercase; letter-spacing: 0.08em; }
